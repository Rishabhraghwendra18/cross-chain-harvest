...
contract TokenTransferor is OwnerIsCreator {
    ...
    constructor(address _router, address _link, uint64 destinationChain,address _tokenAddress) {
    ...
    function setReceiverContract(address _address) external onlyOwner {
        _receiver=_address;
    }
